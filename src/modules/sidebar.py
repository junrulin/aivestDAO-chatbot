...
class Sidebar:
    ...
    MODEL_OPTIONS = ["gpt-3.5-turbo-0125"]
    ...
    @staticmethod
    def about():
        about = st.sidebar.expander("🧠 About aivestDAO ")
        sections = [
            "#### aivestDAO is an AI chatbot with a conversational memory, designed to allow users to discuss their data in a more intuitive way. 📄",
    ...
    def show_options(self):
        with st.sidebar.expander("🛠️ aivestDAO's Tools", expanded=False):
