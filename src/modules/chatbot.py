...
class Chatbot:
    ...
    def conversational_chat(self, query):
        ...
        try:
            ...
            Output the records from the JSON data and format it as a markdown table with Symbol, Weight, Monthly Return, Max Drawdown in 2 digits percentage, Latest Price and Latest Market Cap in float.
