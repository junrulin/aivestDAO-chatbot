...
class Chatbot:
    ...
    def conversational_chat(self, query):
        ...
        performance_str = 'The best portfolio recommended by aivest with modern portfolio theory has monthly return of ' + str(
            round(performance[0], 2)) + ' sharpe ratio of ' + str(round(performance[2], 2))
        ...
        If question contains address, using the final_str to answer the question.
        Output investing style with bullet points.
        Output the records from the JSON data to table.
