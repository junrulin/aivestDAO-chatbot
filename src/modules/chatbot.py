    ...
    def conversational_chat(self, query):
        ...
        if len(address) > 20:
            ...
            try:
                ...
                data_history_bsc = data['historyData']['bsc']

                data_history_eth = data['historyData']['eth']

                data_history = data_history_eth + data_history_bsc
             ...
             #   st.write(data_history)
                ...
                for x in data_history:
                    ...
                    date_x = pd.to_datetime(x.split(",")[0])

            #        st.write(date_x)

             #       st.write(date_x + pd.DateOffset(days=7))

             #       st.write(datetime.datetime.today())

                    if date_x + pd.DateOffset(days=7) > datetime.datetime.today():

                        data_sub_history.append(x)
       ...
       #
            ...
            week_fre = len(data_sub_history)

            half = week_fre//2

            data_1 = data_sub_history[:half]

            data_2 = data_sub_history[half:]
